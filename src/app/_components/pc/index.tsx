...
export default function PcHomePage({
  ...
  const handleSurveyClick = () => {
    window.open('https://example.com/survey', '_blank') // ← アンケートURLここで設定
  }
  ...
  return (
    <article className="hidden h-dvh overflow-hidden md:block">
      <main className="flex h-dvh">
        ...
        {/* 中央カラム */}
        <div className="flex w-full max-w-[680px] flex-col items-center justify-start overflow-y-scroll px-8 pb-6 pt-10">
          {/* タブボタン群 */}
